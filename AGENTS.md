...
When given any prompt related to TESTING, ALWAYS CHECK `docs/TESTING.md` for comprehensive testing guidance and THOROUGHLY understand our testing strategy. Check `tests/setup/README.md` if you need implementation details.
